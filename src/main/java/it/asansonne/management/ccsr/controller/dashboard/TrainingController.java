...
@Tag(name = "TrainingController" + AUTH_HUB_API_VERSION)
public interface TrainingController extends
    GetController<TrainingRequest, TrainingResponse> ,
    PatchController<TrainingRequest, TrainingResponse>,
    PostController<TrainingRequest, TrainingResponse>,
    DeleteController
{
