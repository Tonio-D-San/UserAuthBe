...
public interface RulesetController extends
    GetController<RulesetResponse> ,
    PatchController<RulesetRequest>,
    PostController<RulesetRequest, RulesetResponse>,
    DeleteController
{
  ...
  RulesetResponse findByCode(
      @Parameter(
          name = "code",
          description = "Ruleset code",
          example = "CAMPAIGN"
